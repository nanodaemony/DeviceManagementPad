...
/**
 * Description: AiQin600A数据采集器的Fragment
 *
 * @version: 1.0
 * @author: nano
 * @date: 2020/12/29 13:46
 */
public class FragmentAiQin600A extends android.support.v4.app.Fragment implements FragmentDataExchanger {
    ...
    private TextView tvDataToi3;
    private TextView tvDataToi4;
    private TextView tvDataThi1;
    private TextView tvDataThi2;
    private TextView tvDataThi3;
    private TextView tvDataThi4;


    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_collection_aiqin_600a, container, false);
        ...
        // 获取当前操作的仪器信息
        device = DeviceUtil.getMedicalDevice(DeviceEnum.AI_QIN_EGOS600A);

        // 这里是仪器特有的参数控件
        tvDataToi1 = root.findViewById(R.id.device_data_aiqin_egos_600a_toi1);
        tvDataToi2 = root.findViewById(R.id.device_data_aiqin_egos_600a_toi2);
        tvDataToi3 = root.findViewById(R.id.device_data_aiqin_egos_600a_toi3);
        tvDataToi4 = root.findViewById(R.id.device_data_aiqin_egos_600a_toi4);
        tvDataThi1 = root.findViewById(R.id.device_data_aiqin_egos_600a_thi1);
        tvDataThi2 = root.findViewById(R.id.device_data_aiqin_egos_600a_thi2);
        tvDataThi3 = root.findViewById(R.id.device_data_aiqin_egos_600a_thi3);
        tvDataThi4 = root.findViewById(R.id.device_data_aiqin_egos_600a_thi4);
        return root;
    }
    ...
    public void updateReceiveCounterAndDeviceData(Integer receiveCounter, Object dataObject) {
        this.getActivity().runOnUiThread(() -> {
            ...
            // 转换为数据实体
            DataAiQin600A dataAiQin600A = (DataAiQin600A) dataObject;
            if (dataAiQin600A.getToi1() != DataCons.INVALID_DATA_DOUBLE) {
                tvDataToi1.setText(dataAiQin600A.getToi1() + " %");
                tvDataThi1.setText(dataAiQin600A.getThi1() + "");
            }
            if (dataAiQin600A.getToi2() != DataCons.INVALID_DATA_DOUBLE) {
                tvDataToi2.setText(dataAiQin600A.getToi2() + " %");
                tvDataThi2.setText(dataAiQin600A.getThi2() + "");
            }
            if (dataAiQin600A.getToi3() != DataCons.INVALID_DATA_DOUBLE) {
                tvDataToi3.setText(dataAiQin600A.getToi3() + " %");
                tvDataThi3.setText(dataAiQin600A.getThi3() + "");
            }
            if (dataAiQin600A.getToi4() != DataCons.INVALID_DATA_DOUBLE) {
                tvDataToi4.setText(dataAiQin600A.getToi4() + " %");
                tvDataThi4.setText(dataAiQin600A.getThi4() + "");
            }
        });
