...
/**
 * Description: 名希数据采集器的Fragment
 *
 * @version: 1.0
 * @author: nano
 * @date: 2020/12/29 13:46
 */
public class FragmentMingXi extends android.support.v4.app.Fragment implements FragmentDataExchanger {

    private TextView tvCollectionStatus;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_collection_mingxi, container, false);
        tvCollectionStatus = root.findViewById(R.id.textView_collection_status_mingxi);
